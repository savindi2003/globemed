...
public class allPatients extends javax.swing.JFrame {
    ...
    public static HashMap<String, Integer> insuranceMap = new HashMap();
    public static HashMap<String, Integer> branchMap = new HashMap();
    public static HashMap<String, Integer> clinicMap = new HashMap();
    public static HashMap<String, Integer> departmentMap = new HashMap();
    public static HashMap<String, Integer> staffMap = new HashMap();
    public static HashMap<String, Integer> reasonfMap = new HashMap();
    public static HashMap<String, Integer> roomMap = new HashMap();
    ...
    public allPatients(User currentUser, PermissionService permissionService) {
        initComponents();
        ...
        this.recordManager = new PatientRecordManager(secureDAO); // <-- Bridge + Decorator combo
...
private String safeDecrypt(String value) {
    ...
    private void loadTable() {
        ...
        try {
            ...
            ResultSet rs = recordManager.getPatients();
            ...
            while (rs.next()) {
                ...
                v.add(rs.getString("name")); // decrypt or return as-is
                v.add(rs.getString("age"));
                v.add(rs.getString("gender"));
                v.add(safeDecrypt(rs.getString("mobile")));   // decrypt or return as-is
                v.add(rs.getString("dob"));
                v.add(safeDecrypt(rs.getString("address")));  // decrypt or return as-is
                v.add(rs.getString("registerd_date"));
                v.add(rs.getString("branch.name"));
                v.add("IN0" + rs.getString("insurance_id"));
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel20, javax.swing.GroupLayout.DEFAULT_SIZE, 1337, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Age", "Gender", "Mobile", "Birthday", "Address", "Registerd Date", "Branch"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (name.isEmpty()) {
            ...
            try {
                ...
                recordManager.addPatient(name, birthdayStr, gender, mobile, address, registerd_date, branch, age);
    ...
    private void jTextField7KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField7KeyReleased
        ...
        try {
            ...
            ResultSet rs = recordManager.serchPatients(search);
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            String patient_id = String.valueOf(jTable2.getValueAt(selectedRow, 0));

            dashboard patient_rc = new dashboard(patient_id,currentUser,permissionService);
            patient_rc.setVisible(true);
