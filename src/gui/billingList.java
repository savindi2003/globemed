...
public class billingList extends javax.swing.JFrame {
    ...
    public billingList(User currentUser, PermissionService permissionService) {
        initComponents();
        ...
        jTable1.getColumnModel().getColumn(9).setCellRenderer(new DefaultTableCellRenderer() {
            @Override
            public Component getTableCellRendererComponent(JTable table, Object value,
                ...
                if ("Pending".equalsIgnoreCase(status)) {
                    ...
                    lbl.setForeground(Color.BLACK); // Default
                }
    ...
    private void searchTable(String query) {
        try {
            ...
            ResultSet rs = secureDao.searchBills(query);
            ...
            while (rs.next()) {
                ...
                v.add(rs.getString("billing.bill_number"));
                v.add(rs.getString("appoinment.appoinment_id"));
                v.add(rs.getString("billing.billing_date"));
                v.add(safeDecrypt(rs.getString("patient.name")));

                v.add("Rs. " + rs.getString("billing.base_amount"));
                v.add("Rs. " + rs.getString("billing.extra_amount"));
                v.add("Rs. " + rs.getString("billing.pre_amount"));
                v.add("Rs. " + rs.getString("billing.total_amount"));
                v.add(rs.getString("billing.payment_method"));
                v.add(rs.getString("billing.status"));
    ...
    private void loadTable() {
        try {
            ...
            ResultSet rs = secureDao.loadBills();
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Pending", "Paid", "SETTLED" }));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bill No", "Appointment No", "Date", "Patient", "Base Amount", "Extra Charges", "Prescriptiions", "Total", "Payment Method", "Status"
            }
        ) {
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
            ...
            String query = "`billing`.`bill_number` LIKE '%"+search+"%'";
    ...
    private void jTextField2KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyReleased
        String search = jTextField2.getText();
            ...
            String query = "`patient`.`name` LIKE '%"+search+"%'";
    ...
    private void jComboBox2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox2ItemStateChanged
        ...
        if(status == 1){
            query = "`billing`.`status` = 'Pending' ";
            searchTable(query);
        }else if(status == 2){
            query = "`billing`.`status` = 'Paid' ";
            searchTable(query);
        }else if(status == 3){
            query = "`billing`.`status` = 'SETTLED' ";
            searchTable(query);
        }else{
            loadTable();
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (date != null) {
            ...
            String query = "`billing`.`billing_date` = '"+selectedDate+"' ";
            searchTable(query);
